...
parser.add_argument('--exp', type=str,
                    default='ACDC/WeaklySeg_pCE_Proposed_super0.5_denoise', help='experiment_name')
...
def Inference(FLAGS):
    ...
    metric_hd3 = []
    metric_asd3 = []
    metric_dc,metric_dc2,metric_dc3,metric_jc,metric_jc2,metric_jc3,metric_aasd,metric_aasd2,metric_aasd3,metric_precision,metric_precision2,metric_precision3,metric_ravd,metric_ravd2,metric_ravd3 = []
    ...
    for case in tqdm(image_list):
        ...
        metric_dc.append(first_metric[2])
        metric_dc2.append(second_metric[2])
        metric_dc3.append(third_metric[2])
        metric_jc.append(first_metric[3])
        metric_jc2.append(second_metric[3])
        metric_jc3.append(third_metric[3])
        
        
        
        metric_asd.append(first_metric[4])
        metric_asd2.append(second_metric[4])
        metric_asd3.append(third_metric[4])
        
        
        metric_assd.append(first_metric[5])
        metric_assd2.append(second_metric[5])
        metric_assd3.append(third_metric[5])
        
        metric_precision.append(first_metric[6])
        metric_precision2.append(second_metric[6])
        metric_precision3.append(third_metric[6])
        
        metric_ravd.append(first_metric[7])
        metric_ravd2.append(second_metric[7])
        metric_ravd3.append(third_metric[7])
    ...
    return avg_metric[0][0],avg_metric[0][1],avg_metric[1][0],avg_metric[1][1],avg_metric[2][0],avg_metric[2][1],std1[0],std1[1],std2[0],std2[1],std3[0],std3[1],((avg_metric[0] + avg_metric[1] + avg_metric[2]) / 3)[0],((avg_metric[0] + avg_metric[1] + avg_metric[2]) / 3)[1],((avg_metric[0] + avg_metric[1] + avg_metric[2]) / 3)[2],((avg_metric[0] + avg_metric[1] + avg_metric[2]) / 3)[3],((avg_metric[0] + avg_metric[1] + avg_metric[2]) / 3)[4],((avg_metric[0] + avg_metric[1] + avg_metric[2]) / 3)[5],((avg_metric[0] + avg_metric[1] + avg_metric[2]) / 3)[6],((avg_metric[0] + avg_metric[1] + avg_metric[2]) / 3)[7]
...
if __name__ == '__main__':
    ...
    print("Inference fold{}".format(1))
    
    dice1,hd1,dice2,hd2,dice3,hd3,std_dice1,std_hd1,std_dice2,std_hd2,std_dice3,std_hd3,mean_dice,mean_hd,mean_dc,mean_jc,mean_asd,mean_assd,mean_precision,mean_ravd = Inference(FLAGS)
    print('mean_dice: %f' % ((dice1+dice2+dice3)/3))
    print('mean_hd: %f' % mean_hd)
    print('mean_dc: %f' % mean_dc)
    print('mean_jc: %f' % mean_jc)
    print('mean_asd: %f' % mean_asd)
    print('mean_assd: %f' % mean_assd)
    print('mean_precsion: %f' % mean_precsion)
    print('mean_ravd: %f' % mean_ravd)
