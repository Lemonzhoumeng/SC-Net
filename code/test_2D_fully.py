...
parser.add_argument('--exp', type=str,
                    default="/home/zm/WSL4MIS/model/ACDC_Semi/Entropy_Minimization", help='experiment_name')
...
def Inference(FLAGS):
    ...
    snapshot_path = "/home/zm/WSL4MIS/model/ACDC_Semi/Entropy_Minimization_fold2/label/"
    test_save_path = "/home/zm/WSL4MIS/model/ACDC_Semi/Entropy_Minimization_fold2/label/_predictions/"
    ...
    if FLAGS.fold == "fold5":
        ...
        save_mode_path = os.path.join(snapshot_path, 'unet_best_model.pth')
