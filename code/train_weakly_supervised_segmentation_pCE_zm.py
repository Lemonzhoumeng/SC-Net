...
def train(args, snapshot_path):
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            loss = loss_ce  + consistency_weight * loss_ce_super
            loss.backward()
            optimizer.step()
            ...
            writer.add_scalar('info/loss_ce_super', loss_ce_super, iter_num)

            logging.info(
                'iteration %d : loss : %f, loss_ce: %f,loss_ce_super: %f' %
                (iter_num, loss.item(), loss_ce.item(), loss_ce_super.item()))
